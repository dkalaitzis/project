...
class CarSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('cars')->insert([
            ...
            'cover_img' => 'images/mclaren/mclaren.jpeg',
            'slug' => 'mclaren-720S'
        ]);
        DB::table('cars')->insert([
            ...
            'cover_img' => 'images/ferrari/ferrari.jpeg',
        ...
        DB::table('cars')->insert([
            ...
            'cover_img' => 'images/lambo/lambo.jpeg',
            'slug' => 'lambo-huracan-evo'
        ]);
        DB::table('cars')->insert([
            'car_name'  => 'Ford GT',
            'car_brand' => 'ford',
            ...
            'cover_img' => 'images/ford/ford.jpeg',
            'slug' => 'ford-gt'
        ]);
        DB::table('cars')->insert([
            ...
            'cover_img' => 'images/aston/aston.jpeg',
            'slug' => 'aston-martin-valhala'
        ]);
        DB::table('cars')->insert([
            'car_name'  => 'BMW i8',
            'car_brand' => 'bmw',
            ...
            'cover_img' => 'images/bmw/bmw5.jpeg',
            'slug' => 'bmw-i8'
